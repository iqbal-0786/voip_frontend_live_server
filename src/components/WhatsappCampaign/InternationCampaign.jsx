      ...
      <div className="pagetitle">
        <nav>
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item active">Internation Campaign</li>
          </ol>
        </nav>
      </div>
      <section>
                      ...
                      <div className="m-4">
                        <form method="post">
                          ...
                          <div className="row mb-3">
                            ...
                            <div className="col-sm-6">
                              <textarea
                                className="form-control trt"
                                rows="5"
                                placeholder=" (WAPP Numbers With Country Code)*"
                              ></textarea>
                            </div>
                          </div>
                          <div className="row mb-3">
...
export default InternationCampaign