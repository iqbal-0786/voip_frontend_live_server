                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          ...
                          Corrupti sed aut expedita fugit vero dolorem. Nemo
                          rerum sapiente. A quaerat dignissimos.
                        </div>
                      </div>
                    </div>
                    <div className="accordion-item">
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          ...
                          excepturi itaque est. Sit beatae animi incidunt eum
                          repellat sequi ea saepe inventore. Id et vel et et.
                          Nesciunt itaque corrupti quia ducimus. Consequatur
                          maiores voluptatum fuga quod ut non fuga.
                        </div>
                      </div>
                    </div>
                    <div className="accordion-item">
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          ...
                          laboriosam molestiae qui molestias placeat corrupti
                          non quo accusamus. Nemo qui quis harum enim sed.
                          Aliquam molestias pariatur delectus voluptas quidem
                          qui rerum id quisquam. Perspiciatis voluptatem
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header">
                        <button
                          ...
                          data-bs-toggle="collapse"
                        >
                          Quaerat qui est iusto asperiores qui est reiciendis
                          eos et?
                        </button>
                      </h2>
                      <div
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header">
                        <button
                          ...
                          data-bs-toggle="collapse"
                        >
                          Assumenda doloribus est fugiat sint incidunt animi
                          totam nisi?
                        </button>
                      </h2>
                      <div
